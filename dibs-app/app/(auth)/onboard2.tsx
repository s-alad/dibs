...
export default function Onboard2() {
    ...
    return (
        <View style={{ display: "flex", flex: 1, alignItems: "center", backgroundColor: "black", justifyContent:"center" }}>
            <Text style={{color:"white", fontSize: 25, fontFamily: "lato", textAlign:"center", fontWeight:"bold", marginHorizontal: 50}}>sdsdvwelcome to dibs,
            ...
            <Link href="/onboard3" style= {{position:"absolute", bottom:10, right:30}}>
